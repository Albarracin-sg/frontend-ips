...
const TicketCard = () => {
    return (
        <>
            ...
            <div>
                {/* Formulario con estilos responsivos usando SM y LG breakpoints */}
                <form className="bg-[#d9d9d9] border-[7px] border-[#3c3c3c] p-[0_15px] max-w-[320px] h-[500px]
                sm:bg-[#d9d9d9] sm:border-[10px] sm:border-[#3c3c3c] sm:p-[0_30px] sm:w-[90%] sm:max-w-[500px] sm:h-[550px]
                lg:bg-[#d9d9d9] lg:border-[12px] lg:border-[#3c3c3c] lg:p-[0_40px] lg:w-[90%] lg:max-w-[500px] lg:h-[600px]">
                    ...
                    {/* SVG para el diseño del ticket - Adaptado para ser responsivo */}
                    <svg
                        width="100%"
                        height="65%"
                        viewBox="0 0 359 527"
