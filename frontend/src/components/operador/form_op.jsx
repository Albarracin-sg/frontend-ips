    ...
    const formop = () => {
        ...
        <div className="relative flex min-h-screen w-screen bg-gradient-to-l from-[#E1EAF0] via-[#4187B5] to-[#2F688D] overflow-y-auto">
            ...
            <div className=" w-[45.6%] border-l-[3px] border-[#3c3c3c] h-[580px] pl-20 flex flex-col items-center mt-[-45px]">
                ...
                <button
                type="submit"
                className="bg-[#6EA3C7] font-bold w-[190px] h-[66.5px] text-white py-[3.099375px] mt-15 rounded-lg hover:bg-[#3c3c3c] transition-colors mx-auto block text-[18px]"
                >
                SIGUIENTE TURNO
                </button>
            </div>
